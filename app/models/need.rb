...
class Need
  ...
  PUBLISHING_API_FIELDS = %w(title details base_path schema_name locale phase redirects update_type public_updated_at first_published_at last_edited_at publication_state state_history routes description)
